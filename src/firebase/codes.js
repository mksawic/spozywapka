//https://github.com/maxzaleski/firebase-error-codes/blob/master/src/codes/auth.js
...
export const authMessages = {
  [authCodes.invalidEmail]: "Nieprawidłowy adres email",
  [authCodes.wrongPassword]: "Nieprawidłowe hasło",
  [authCodes.userNotFound]: "Nieprawidłowy email lub hasło",
  [authCodes.weakPassword]:
    "Nieprawidłowe hasło (hasło musi zawierać minimum 6 znaków)",
  [authCodes.emailAlreadyInUse]: "Podany adres email już istnieje",
};
